...
Bra tiltak, men kommunikasjonen har noen hull:

**Problemet:** Dere gir folk 8 dager (fra nå til 31.01) til å oppdage at de trenger en utvidelse, finne ut hvilken, og melde inn. Det er for kort, spesielt for folk som er på ferie eller i prosjekter.

**Konkrete forbedringer:**
1. **Flytt fristen** - Gi minst 2-3 uker etter at meldingen går ut
2. **Vær tydelig på hva som skjer etter 01.02** - Blir utvidelser slettet? Deaktivert? Kan man fortsatt søke etterpå?
3. **Legg til kontaktinfo** - Hvem kontakter man hvis noe slutter å fungere 02.02?

**Det som fungerer:** Tydelig liste over standardutvidelser, konkret veiledning for å sjekke egne utvidelser, link til skjema.
...
**Problemet:** Dere gir folk 8 dager (fra nå til 31
