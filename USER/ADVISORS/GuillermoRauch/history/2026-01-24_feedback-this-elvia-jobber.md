# Consultation: feedback this elvia jobber
...
**Standardlisten er merkelig:** Dere har Google Docs, Sheets, Slides, Drive, Mail - men bruker dere faktisk Google Workspace, eller er dette bare "kom med i pakka"? Hvis Elvia er et Microsoft-hus (dere har Power Automate, SSO), skaper dette forvirring.

**Mangler utviklerverktøy:** DevTools Enhancements er der, men hva med React DevTools, Redux DevTools, eller andre debugging-verktøy? Utviklere vil klage dag 1.

**Salesforce Inspector Reloaded** i standard men ikke andre debugging-verktøy? Det antyder at noen har meldt inn behov mens andre ikke vet at de kan.

**Forslag:** Send en heads-up til utviklerteamene *før* denne går ut bredt. La dem definere en "developer standard set" så dere slipper 50 individuelle søknader.
...
**Standardlisten er merkelig:** Dere har Google Docs, Sheets, Slides, Drive, Mail - men bruker dere faktisk
